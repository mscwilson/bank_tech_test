...
describe BankAccount do
  ...
  describe '#deposit' do
    ...
    it "prevents very large deposits" do
      expect { account.deposit(100000) }.to output("Unable to process large deposit. Please speak to your bank manager.\n").to_stdout
    end
  ...
  describe '#withdraw' do
    ...
    it 'prevents large withdrawals' do
      ...
      expect { account.withdraw(2501) }.to output("Amount exceeds daily limit. Please speak to your bank manager to withdraw large sums.\n").to_stdout
    end
  end
